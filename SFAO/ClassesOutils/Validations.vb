...
Module Validations
    ...
    Public Sub AssignValidation(ByRef CTRL As Windows.Forms.TextBox, ByVal Validation_Type As ValidationType)
        ...
        Select Case Validation_Type
            ...
            Case ValidationType.Matricule
                AddHandler txt.KeyPress, AddressOf Matricule_Leave
        End Select
    End Sub
    Public Sub number_Leave(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        Dim numbers As Windows.Forms.TextBox = CType(sender, TextBox)
    ...
    Public Sub NotNull_Leave(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim No As Windows.Forms.TextBox = CType(sender, TextBox)
    ...
    Public Sub Email_Leave(ByVal sender As Object, ByVal e As System.EventArgs)
        Dim Email As Windows.Forms.TextBox = CType(sender, TextBox)
        If Email.Text <> "" Then
        ...
        End If
    End Sub
    Public Sub Matricule_Leave(ByVal sender As Object, ByVal e As System.Windows.Forms.KeyPressEventArgs)
        Dim numbers As Windows.Forms.TextBox = CType(sender, TextBox)
