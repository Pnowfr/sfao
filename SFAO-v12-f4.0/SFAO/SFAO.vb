...
Module SFAO
    ...
    Private Sub GenFichierConf()
        ...
        Try
            ...
            AddPar("WEBSERVEURURL", "http://77.158.76.198/soap-generic/syracuse/collaboration/syracuse/CAdxWebServiceXmlCC", "GBIV12 (ext)")
            ...
            AddPar("WEBSERVEURURL", "http://77.158.76.198/soap-generic/syracuse/collaboration/syracuse/CAdxWebServiceXmlCC", "REING (ext)")
            AddPar("WEBSERVEURUSER", "web", "REING (ext)")
    ...
    Private Sub VerifUpdate()
        ...
        Else
            ...
            'TODO Fidy si version facultative question à l'utilisateur : Nouvelle version de la SFAO disponible, voulez lancer la mise à jour ?
            'si ^réponse = non => pas de copie de SFAO-upd.exe et pas de lancement de la mise à jour + désactiver le timer par UpdSFAO = False

            'TODO Fidy si vesrion obligatoire : message utilisateur : Nouvelle version de la SFAO disponible, lancement de la mise à jour.

            ' on le copie dans le dossier de l'appli client le SFAO-Upd.exe
